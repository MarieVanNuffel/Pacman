...
namespace logic {
     ...
     *
     * Behaviors: Waiting, Chase, Fear, Eaten. Ghost heeft pointer naar World (worldRef) om helpers te gebruiken.
     */
    ...
    public:
         ...
         */
        enum class GhostType { LockedRandom, AheadOfPacman1, AheadOfPacman2, DirectChase };

...
#include <SFML/Graphics.hpp>
     ...
     * Voor het design/de animatie heb ik AI gebruikt om SFML functies op te zoeken voor hoe ik het kon implementeren.
     *
     * Het design bevat de titel in de originele kleuren met daaronder een animatie van de ghosts die achter pacman zweven.
     * Er is ook een play button die van kleur verandert als je met je muis erover gaat en de highscores met 1 in goud, 2 in zilver en 3 in brons.
     *
     * @param window
     * @param sm
     */

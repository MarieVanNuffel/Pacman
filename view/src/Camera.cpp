...
namespace view {
    ...
    std::pair<double,double> Camera::tileToNormalized(double tileX, double tileY) const {
    ...
    sf::FloatRect Camera::normalizedToPixels(double nx, double ny, double wFrac, double hFrac) const {

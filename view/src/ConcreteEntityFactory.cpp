...
namespace view {
    ...
    ConcreteEntityFactory::createPacmanView(std::shared_ptr<logic::PacManModel> m) {
        ...
        std::shared_ptr<logic::Observer> obs = std::static_pointer_cast<logic::Observer>(v); // view implementeert observer
        return { v, obs };
    }
    ...
    ConcreteEntityFactory::createGhostView(std::shared_ptr<logic::GhostModel> m) {
        ...
        return { v, nullptr }; // ghosts maken geen gebruik van een observer, dus nullpointer wordt teruggegeven
    }
    ...
    ConcreteEntityFactory::createCoinView(std::shared_ptr<logic::CoinModel> m) {
        ...
        std::shared_ptr<logic::Observer> obs = std::static_pointer_cast<logic::Observer>(view); // view implementeert observer
        return { view, obs };
    }
    ...
    ConcreteEntityFactory::createGhostDoorView(std::shared_ptr<logic::GhostDoorModel> m) {
        auto view = std::make_shared<GhostDoorView>(m); // ghostdoorview wordt aangemaakt
        return { view, nullptr }; // ghosts maken geen gebruik van een observer, dus nullpointer wordt teruggegeven
    }
}